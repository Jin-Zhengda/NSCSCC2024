...
(
    ...
    assign final_inst = dispatch_i[0].aluop == `ALU_RRIWINZ || dispatch_i[1].aluop == `ALU_RRIWINZ;
    ...
    assign issue_double_en = !privilege_inst && !mem_inst && !data_relate_inst && !cnt_inst && !final_inst && (&inst_valid);
